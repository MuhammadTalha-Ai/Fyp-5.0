...
from fyp.views import predict_view, predict_view1, predict_view2, predict_view3,simple_chatbot,predict_live_view,chat_with_bot,threat_suggestion_from_llm
